                ...
                <View style={styles.divCompView}>
                    <View style={styles.containsView}>
                        <View style={styles.statusStyle}>
                            ...
                            {item.type?item.type == 'Credit'?<Text style={styles.historyamounttextStyle}>{item.type + 'ed '+ Currency + parseFloat(item.amount).toFixed(2) + ' '+ languageJSON.successfully}</Text>:
                                <Text style={styles.historyamounttextStyle}>{item.type + 'ed '+ Currency + parseFloat(item.amount).toFixed(2)+ ' '+ languageJSON.form_wallet}</Text>
                            :null}
