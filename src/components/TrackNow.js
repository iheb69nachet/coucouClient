                                ...
                                if(!this.state.allData.flag){
                                    ...
                                    dat.once('value',snapshot=>{
                                        if(snapshot.val() && snapshot.val().pushToken){
                                            RequestPushMsg(snapshot.val().pushToken,'Driver Near you')
                                            paramData.flag = true;
                                        }
                                        })
                                }
    ...
    return (
            ...
            longitudeDelta: LONGITUDE_DELTA
                ...
                /> */}
                 {/* <Marker
                // ref={markerRef}
                coordinate={{latitude: this.state.allData?this.state.allData.droplatitude:0.00, longitude: this.state.allData?this.state.allData.droplongitude:0.00}}
                image={require('../../assets/images/track_Car.png')}
                /> */}
                <Marker
                    // ref={markerRef}
