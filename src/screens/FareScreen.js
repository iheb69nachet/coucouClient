...
const styles = StyleSheet.create({
    ...
    whereText: { flex: 9,  fontSize: 14, fontWeight: '400', color: colors.WHITE },
    ...
    totalFareText: { color: colors.GREY.btnPrimary, fontSize: 15 },
    infoIcon: { flex: 2, alignItems: 'center', justifyContent: 'center' },
    priceText: { alignSelf: 'center', color: colors.GREY.iconSecondary, fontSize: 20 },
    triangle: {
        width: 0,
        height: 0,
    ...
    buttonText: { color: colors.WHITE, fontSize: 17, alignSelf: 'flex-end' },
    ...
    fareText: { top: 40, color: colors.BLACK, fontSize: 20, alignSelf: 'center' },
    ...
    fareTitleText: { flex: 1, fontSize: 14, color: colors.BLACK },
    ...
    farePriceText: { flex: 1,  fontSize: 16, fontWeight: '900', color: colors.BLACK },
    discountPriceText: { flex: 1,  fontSize: 16, fontWeight: '900', color: colors.LIGHT_RED },
    ...
    totalPriceText: { flex: 0.5, paddingTop: 10, fontSize: 16, fontWeight: '900', color: colors.BLACK },
    taxText: { flex: 1, marginTop: 0,  fontSize: 13, fontWeight: '900', color: colors.GREY.secondary },
    totalPriceNumberContainer: { flex: 1, alignItems: 'flex-end', justifyContent: 'space-between' },
    totalPriceNumber: { flex: 1, paddingTop: 10, fontSize: 18, fontWeight: '900', color: colors.BLACK },
    termsContainer: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingLeft: 10 },
    termsText: { flex: 1,  fontSize: 12, color: colors.GREY.btnSecondary },
    ...
    rideCancelText: { flex: 1, top: 15, color: colors.BLACK, fontSize: 20, alignSelf: 'center' },
    ...
    cancelMsgText: { color: colors.BLACK,  fontSize: 15, alignSelf: 'center', textAlign: 'center' },
