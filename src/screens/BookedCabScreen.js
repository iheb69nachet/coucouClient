...
const styles = StyleSheet.create({
    ...
    cabText: { paddingLeft: 10, alignSelf: 'center', color: colors.BLACK},
    cabBoldText: {fontFamily:'Roboto-Bold'},
    otpText: { paddingRight: 10,alignSelf: 'center', color: colors.BLACK},
    ...
    cabNameText: { color: colors.GREY.btnPrimary, fontSize: 13 },
    ...
    cabNumberText: { color: colors.GREY.iconSecondary, fontSize: 13 },
    ...
    driverNameText: { color: colors.GREY.btnPrimary, fontSize: 14 },
    ...
    buttonTitleText: {color:colors.WHITE, fontSize: 18, alignSelf:'flex-end'},
    ...
    cancelReasonText: { top:10, color:colors.BLACK, fontSize:20, alignSelf: 'center'},
