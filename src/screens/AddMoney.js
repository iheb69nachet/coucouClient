    ...
    return (
        <View style={styles.mainView}>
            ...
            <View style={styles.bodyContainer}>
              <Text style={styles.walletbalText}>{languageJSON.Balance} - <Text style={styles.ballance}>{Currency}{this.state.allData?parseFloat(this.state.allData.walletBalance).toFixed(2):''}</Text></Text> 
