export default {
    ...
    password_alphaNumeric_check:'Le mot de passe doit être composé d\'au moins 1 caractère alphanumérique et d\'une longueur de 8 à 15.',
    ...
    static_notification_title:'CouCou Notification',
    ...
    first_name_blank_error:"Veuillez saisir votre Prénom.",
    last_name_placeholder:'Nom',
    last_name_blank_error:'Veuillez saisir votre Nom.',
    mobile_no_placeholder:'Numéro de portable',
    mobile_no_blank_error:'Veuillez saisir un numéro de téléphone portable valide.',
    ...
    book_your_ride_menu:'Demander',
    profile_setting_menu:'Mon profil',
    my_wallet_menu:'Crédits',
    my_rides_menu:'Mes courses',
    ...
    map_screen_where_input_text:'D\'où ?',
    map_screen_drop_input_text:'Vers où ?',
    ...
    map_screen_title:'CouCou Coursier',
    cab_selection_title:'Choisissez votre Coursier',
    cab_selection_subtitle:'Appuyez pour sélectionner le Coursier et Demander maintenant',
    not_available:'Not Available',
    book_now_button:'Commandez maintenant',
    contact_details:'Contact Details',
    phone:'Phone',
    my_wallet_tile:'Mon portefeuille',
    wallet_ballance:'Mon Solde',
    add_money:'ajouter de l\'argent',
    transaction_history_title:'Historique des transactions',
    successfully:'Successfully',
    form_wallet:'form wallet',
    Transaction_Id :'Transaction Id ',
    ride_list_title:'Mes Courses',
    ...
    call_driver:'Appelez le Coursier',
    booked_cab_title:'Booked Cab',
    you_selected:'You Selected -',
    otp:'OTP :',
    driver_assign_messege:'Le Coursier affectera bientôt ..',
    ...
    sorry:'Sorry',
    multipleBooking:'CouCou currently doesn\'t support multiple bookings.',
    ...
    addMoneyTextInputPlaceholder:'Ajouter un montant (€)',
    ...
    Balance:'CouCou Balance',
    android_channel: 'CouCou Notifications'
}
